module LeaveRequestsHelper
	...
	def leaves_holidays_tabs
		...
		if LeavesHolidaysLogic::has_manage_rights(User.current) || LeavesHolidaysLogic::has_vote_rights(User.current) || LeavesHolidaysLogic::has_view_all_rights(User.current)
